var shareConfig = {
  title: "Jump high, fly higher, let's go."
};
...
function init() {
	...
	dvid = 0; - 1 < e.indexOf("Android") && (dvid = 1, 4 <= Math.floor(navigator.userAgent.substr(e.indexOf("Android") + 8, 1)) && (dvid = 2)); - 1 < e.indexOf("iPad") && (dvid = 3); - 1 < e.indexOf("iPhone") && (dvid = 4, 2 <= window.devicePixelRatio && (dvid = 5, 416 == window.screen.height && (dvid = 5)));
	wdpr = 1;
	...
	askb = 1;
	e = navigator.language; - 1 < document.URL.indexOf("page") ? (e = ["title_jmp_nolink.jpg", "cs_jmp.gif", "cs_jmp_bg.jpg", "cs_jmp_nolink.png"], canvas.style.backgroundImage = "url(images/title_jmp_nolink.jpg)", shms1 = "Browser game[SKY JUMP] SCORE=", shms2 = "Browser game[SKY JUMP]", shms3 = "Why don't you get useful tips by sharing this game to your friends?", shms4 = "Why don't you get useful items by sharing this game to your friends?") : -1 < e.indexOf("ja") ? (e = ["title_jmp_jp.jpg", "cs_jmp.gif", "cs_jmp_bg.jpg", "cs_jmp_jp.png"], canvas.style.backgroundImage = "url(images/title_jmp_jp.jpg)", shms1 = "�����ɗV�ׂ�u���E�U�Q�[���uSKY JUMP�v SCORE=", shms2 = "�����ɗV�ׂ�u���E�U�Q�[���uSKY JUMP�v", shms3 = "�F�B�Ƃ��̃Q�[�����V�F�A���āA�𗧂�TIPS���Q�b�g���悤�I", shms4 = "�F�B�Ƃ��̃Q�[�����V�F�A���āA�A�C�e�����Q�b�g���悤�I") : (e = ["title_jmp.jpg", "cs_jmp.gif", "cs_jmp_bg.jpg", "cs_jmp.png?d"], canvas.style.backgroundImage = "url(images/title_jmp.jpg)", shms1 = "Browser game[SKY JUMP] SCORE=", shms2 = "Browser game[SKY JUMP]", shms3 = "Why don't you get useful tips by sharing this game to your friends?", shms4 = "Why don't you get useful items by sharing this game to your friends?");
	img0 = new Image;
	img0.src = "images/" + e[0];
